...
public:
    ...
    ECConsoleUIButton(int xUL, int yUL, int xLR, int yLR, const std::string &textButton, ECConsoleUIListBox* departureList, ECConsoleUIListBox* arrivalList, ECConsoleUIListBox* itin, ECAirlineSimulator& simulator, ECConsoleUIView& view);
    ...
    std::string dump(const ECFlightItinerary& itinerary);
    
private:
    std::string strButton;

    ECConsoleUIListBox* departureList;
    ECConsoleUIListBox* arrivalList;
    ECConsoleUIListBox* itin;
